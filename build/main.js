...
var ASM_CONSTS = {
  2620: function() {canvas = document.getElementById("main_canvas"); context = canvas.getContext("2d"); context.lineJoin = "round"; context.font = "#FONT_SIZEpx Arial";},  
 2773: function() {context.beginPath();},  
 2798: function($0, $1) {context.moveTo($0, $1);},  
 2824: function($0, $1) {context.lineTo($0, $1);},  
 2850: function($0, $1, $2, $3, $4) {context.arc($0, $1, $2, $3, $4)},  
 2884: function($0, $1, $2, $3) {context.rect($0, $1, $2, $3)},  
 2915: function($0, $1, $2, $3) {var view = Module.HEAPU8.subarray($0, $0 + $1); var string = ''; for (let i = 0; i < $1; i++) { string += String.fromCharCode(view[i]); } label_extent = context.measureText(string); context.fillText(string, $2, $3)},  
 3134: function() {context.stroke();},  
 3154: function($0) {context.lineWidth = $0;},  
 3180: function($0, $1, $2) {context.strokeStyle = "rgb(" + String($0) +", " + String($1) + ", " + String($2) + ")";},  
 3270: function() {context.save(); context.setTransform(1, 0, 0, 1, 0, 0); context.clearRect(0, 0, canvas.width, canvas.height); context.restore();},  
 3403: function($0, $1) {context.translate($0, $1);},  
 3432: function($0, $1, $2, $3, $4, $5) {context.setTransform( $0, $1, $2, $3, $4, $5 );},  
 3484: function() {bounding_rect = canvas.getBoundingClientRect();},  
 3536: function() {return bounding_rect.x},  
 3561: function() {return bounding_rect.y},  
 3586: function() {return bounding_rect.width},  
 3615: function() {return bounding_rect.height},  
 3645: function($0, $1, $2, $3) {context.moveTo($0, $1); context.lineTo($2, $3); context.stroke();},  
 3715: function($0, $1) {var view = Module.HEAPU8.subarray($0, $0 + $1); var string = ''; for (let i = 0; i < $1; i++) { string += String.fromCharCode(view[i]); } label_extent = context.measureText(string);},  
 3901: function() {return label_extent.width;},  
 3931: function() {var ptr = allocate( intArrayFromString(document.getElementById("label").value), ALLOC_NORMAL ); return ptr;},  
 4043: function() {text_output = document.getElementById("text_output");},  
 4101: function($0, $1) {var view = Module.HEAPU8.subarray($0, $0 + $1); var string = ''; for (let i = 0; i < $1; i++) { string += String.fromCharCode(view[i]); } text_output.value = string;},  
 4271: function() {text_output.select();}
};
